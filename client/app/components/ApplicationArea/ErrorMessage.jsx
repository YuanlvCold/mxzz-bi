...
function getErrorMessageByStatus(status, defaultMessage) {
  switch (status) {
    case 404:
      return __("It seems like the page you're looking for cannot be found.");
    case 401:
    case 403:
      return __("It seems like you don’t have permission to see this page.");
    default:
...
export function getErrorMessage(error) {
  const message = __("It seems like we encountered an error. Try refreshing this page or contact your administrator.");
  if (isObject(error)) {
    // HTTP errors
