...
function CreateUserDialog({ dialog }) {
  ...
  const formFields = useMemo(() => {
    ...
    return [
      { ...common, name: "name", title: __("Name"), type: "text", autoFocus: true },
      { ...common, name: "email", title: __("Email"), type: "email" },
    ];
  }, [createUser]);

  return (
    <Modal {...dialog.props} title={__("Create a New User")} okText={__("Create")} onOk={createUser}>
