...
function TextboxDialog({ dialog, isNew, ...props }) {
  ...
  return (
    <Modal
      {...dialog.props}
      title={isNew ? __("Add Textbox") : __("Edit Textbox")}
      onOk={saveWidget}
      okText={isNew ? __("Add to Dashboard") : __("Save")}
      width={500}
      ...
      <div className="textbox-dialog">
        <Input.TextArea
          ...
          autoFocus
          placeholder={__("This is where you write some text")}
        />
        <small>
          {__("Supports basic")}{" "}
        ...
        {text && (
          <React.Fragment>
            <Divider dashed />
            <strong className="preview-title">{__("Preview")}:</strong>
