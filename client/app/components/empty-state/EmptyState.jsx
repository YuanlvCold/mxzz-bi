        ...
        <ol>
          ...
          {!currentUser.isAdmin && (
            <Step
              show={isAvailable.dataSource}
              completed={isCompleted.dataSource}
              text={__("Ask an account admin to connect a data source")}
            />
          )}
          <Step
          ...
          <Step
            ...
            url="users/new"
            urlText={__("Invite")}
            text={__("your team members")}
          />
        </ol>
        <p>
        {__("Need more support?")}{" "}
