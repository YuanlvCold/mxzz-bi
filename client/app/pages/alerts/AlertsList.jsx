...
class AlertsList extends React.Component {
  ...
  listColumns = [
    ...
    Columns.timeAgo.sortable({ title: __("Last Updated At"), field: "updated_at", className: "text-nowrap", width: "1%" }),
    Columns.dateTime.sortable({ title: __("Created At"), field: "created_at", className: "text-nowrap", width: "1%" }),
  ];
          ...
          <div className="m-l-15 m-r-15">
            ...
            {controller.isLoaded && controller.isEmpty && (
              <EmptyState
                icon="fa fa-bell-o"
                illustration="alert"
                description={__("Get notified on certain events")}
