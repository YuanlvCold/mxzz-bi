                  ...
                  <section className="query-editor-wrapper" data-test="QueryEditor">
                    ...
                    <QueryEditor.Controls
                      addParameterButtonProps={{
                        title: __("Add New Parameter"),
                        shortcut: "mod+p",
                        onClick: openAddNewParameterDialog,
                      }}
                      formatButtonProps={{
                        title: __("Format Query"),
                      ...
                      saveButtonProps={
                        queryFlags.canEdit && {
                          text: (
                            <React.Fragment>
                              <span className="hidden-xs">{__("Save")}</span>
                      ...
                      executeButtonProps={{
                        ...
                        text: (
                          <span className="hidden-xs">{selectedText === null ? __("Execute") : __("Execute Selected")}</span>
                        ),
                      }}
