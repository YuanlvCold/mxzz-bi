            ...
            <FavoriteList
              ...
              emptyState={
                <p>
                  ...
                  {__("Favorite")} <a href="dashboards">{__("Dashboards")}</a> {__("will appear here")}
                </p>
              }
            />
          </div>
            ...
            <FavoriteList
              ...
              emptyState={
                <p>
                  ...
                  {__("Favorite")} <a href="queries">{__("Queries")}</a> {__("will appear here")}
                </p>
              }
            />
          </div>
  ...
  return (
    <div className="home-page">
      <div className="container">
        ...
        <EmptyState
          header={__("Welcome to Redash 👋")}
          description={__("Connect to any data source, easily visualize and share your data")}
