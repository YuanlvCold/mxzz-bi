          ...
          <div className="d-flex">
            <Form className="flex-fill">
              <div className="m-b-30">
                {__("Start by selecting the query that you would like to monitor using the search bar.")}
                <br />
                {__("Keep in mind that Alerts do not work with queries that use parameters.")}
              </div>
