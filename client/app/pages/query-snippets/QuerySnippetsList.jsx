...
class QuerySnippetsList extends React.Component {
  ...
  deleteQuerySnippet = (event, querySnippet) => {
    Modal.confirm({
      title: __("Delete Query Snippet"),
      content: __("Are you sure you want to delete this query snippet?"),
      okText: __("Yes"),
      okType: "danger",
      cancelText: __("No"),
      onOk: () => {
        QuerySnippet.delete(querySnippet)
          .then(() => {
            notification.success(__("Query snippet deleted successfully."));
            this.props.controller.update();
          })
          .catch(() => {
            notification.error(__("Failed deleting query snippet."));
          });
      },
    });
  };
      ...
      <div>
        ...
        {controller.isLoaded && controller.isEmpty && (
          <div className="text-center">
            {__("There are no query snippets yet.")}
