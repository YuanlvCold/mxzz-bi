...
class GroupDataSources extends React.Component {
  ...
  addDataSources = () => {
    ...
    SelectItemsDialog.showModal({
      dialogTitle: __("Add Data Sources"),
      inputPlaceholder: __("Search data sources..."),
      selectedItemsTitle: __("New Data Sources"),
          ...
          <Layout.Content>
            ...
            {controller.isLoaded && controller.isEmpty && (
              <div className="text-center">
                <p>{__("There are no data sources in this group yet.")}</p>
                {currentUser.isAdmin && (
