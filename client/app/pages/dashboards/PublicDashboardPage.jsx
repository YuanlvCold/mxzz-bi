      ...
      <div className="public-dashboard-page">
        {loading ? (
          <div className="container loading-message">
            <BigMessage className="" icon="fa-spinner fa-2x fa-pulse" message={__("Loading...")} />
          </div>
        ) : (
        ...
        <div id="footer">
          <div className="text-center">
            <a href="https://www.muxingyun.com">
              <img alt={__("Redash Logo")} src={logoUrl} width="38" />
            </a>
          </div>
          {__("Powered by")} <a href="https://www.muxingyun.com">{__("Redash")}</a>
        </div>
      </div>
    );
  }
