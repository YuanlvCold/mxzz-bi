...
class ShareDashboardDialog extends React.Component {
    ...
    return (
      <React.Fragment>
        ...
        <div className="modal-header-desc">
          {__("Allow public access to this dashboard with a secret address.")} <HelpTrigger type="SHARE_DASHBOARD" />
        </div>
      </React.Fragment>
    );
  }
  ...
  enableAccess = () => {
    ...
    axios
      ...
      .catch(() => {
        notification.error(__("Failed to turn on sharing for this dashboard"));
      })
      .finally(() => {
